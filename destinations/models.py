...
class Destination(BaseModel):
    ...
    destination_imageURL = models.URLField(null=True)
    destination_imageURL_2 = models.URLField(null=True)
    destination_imageURL_3 = models.URLField(null=True)
    destination_imageURL_4 = models.URLField(null=True)
    destination_imageURL_5 = models.URLField(null=True)
    destination_imageURL_6 = models.URLField(null=True)
